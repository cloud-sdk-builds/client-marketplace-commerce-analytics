...
[`@aws-sdk/client-marketplace-commerce-analytics`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-commerce-analytics/v/3.679.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.679.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ao2jRvcnoI4vQm/IMbWHZ40TRHkTpuuJ5i+43A9qo2xwqu3C24EBU6ldLHDo8Ui5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-commerce-analytics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.679.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.679.0/index.min.mjs": "sha384-ao2jRvcnoI4vQm/IMbWHZ40TRHkTpuuJ5i+43A9qo2xwqu3C24EBU6ldLHDo8Ui5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-commerce-analytics/blob/refs/tags/3.679.0/LICENSE
```
