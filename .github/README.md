...
[`@aws-sdk/client-marketplace-commerce-analytics`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-commerce-analytics/v/3.1118.0).
...
- @aws-sdk/client-marketplace-commerce-analytics v3.1118.0 - [https://cloud-sdk-builds.github.io/?sdk=client-marketplace-commerce-analytics&version=3.1118.0](https://cloud-sdk-builds.github.io/?sdk=client-marketplace-commerce-analytics&version=3.1118.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.1118.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iFwS/xVKKI+kcpAnDrU3xoeNeEMtIPlDjPEmqjzDpHER0zIUnBi5hdjofUUA+hql
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-commerce-analytics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.1118.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.1118.0/index.min.mjs": "sha384-iFwS/xVKKI+kcpAnDrU3xoeNeEMtIPlDjPEmqjzDpHER0zIUnBi5hdjofUUA+hql"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-commerce-analytics/blob/refs/tags/3.1118.0/LICENSE
```
