...
[`@aws-sdk/client-marketplace-commerce-analytics`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-commerce-analytics/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kd8/0EY1mI4eB7zYxyPrpJlFWafLNZdCqJY5AvdBK7pNRJHDoZtDD4x1/7E9CLZl
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-commerce-analytics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.991.0/index.min.mjs": "sha384-kd8/0EY1mI4eB7zYxyPrpJlFWafLNZdCqJY5AvdBK7pNRJHDoZtDD4x1/7E9CLZl"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-commerce-analytics/blob/refs/tags/3.991.0/LICENSE
```
