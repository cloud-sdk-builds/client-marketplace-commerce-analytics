...
[`@aws-sdk/client-marketplace-commerce-analytics`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-commerce-analytics/v/3.1117.0).
...
- @aws-sdk/client-marketplace-commerce-analytics v3.1117.0 - [https://cloud-sdk-builds.github.io/?sdk=client-marketplace-commerce-analytics&version=3.1117.0](https://cloud-sdk-builds.github.io/?sdk=client-marketplace-commerce-analytics&version=3.1117.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.1117.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5tLD+MwDPbKbLJYTm3MtKfBgAfzFut1ptVTTPXs1Yi9MqgOIUvYXKXHMAfrBNYUN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-commerce-analytics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.1117.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-commerce-analytics@3.1117.0/index.min.mjs": "sha384-5tLD+MwDPbKbLJYTm3MtKfBgAfzFut1ptVTTPXs1Yi9MqgOIUvYXKXHMAfrBNYUN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-commerce-analytics/blob/refs/tags/3.1117.0/LICENSE
```
